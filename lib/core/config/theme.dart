...
class AppTheme {
  ...
  Future<ThemeMode> _getThemeMode() async {
    ...
    themeMode = _instance.prefs.getString('themeMode') == null
        ? 'system'
        : _instance.prefs.getString('themeMode')!;
    switch (themeMode) {
      case 'light':
  ...
  Future<void> changeThemeMode(ThemeMode newThemeMode,
    ...
    await _instance.prefs.setString('themeMode', _instance.themeMode.name);
    Get.appUpdate();
  }
...
//* light Theme
  final ThemeData lightTheme = ThemeData(
      ...
      appBarTheme: const AppBarTheme(
        backgroundColor: Color.fromARGB(255, 91, 151, 255),
      ...
      // Divider
      dividerTheme: DividerThemeData(color: Color.fromARGB(255, 100, 100, 100))
      //>
      );
  ...
  final ThemeData darkTheme = ThemeData(
      ...
      //< App Bar Theme
      appBarTheme: const AppBarTheme(
        backgroundColor: Color.fromARGB(255, 70, 119, 204),
        shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.only(
                bottomLeft: Radius.circular(10),
                bottomRight: Radius.circular(10))),
        shadowColor: Color.fromARGB(188, 255, 255, 255),
        elevation: 6,
        scrolledUnderElevation: 10,
      ...
      // Divider
      dividerTheme: DividerThemeData(color: Color.fromARGB(255, 205, 205, 205))
      //>
      );
}
